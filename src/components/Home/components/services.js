...
const servicesMedia = [
  {
    ...
    text: `Blue Slate Properties is the premier builder of new Loft style condominiums in the Chicago
          ...
          of our
          buyers and provide a complete solution with luxury amenities as standard in all of our
          properties.
  ...
  },
  {
    ...
    text: `Blue Slate Properties, LLC carefully screens all apartment applications for our buildings by
          ...
          All
          applications must then be approved by the property manager for that building and one of the
          firm’s
  ...
  },
  {
    ...
    text: `Our company stays current on all legal issues and changes in the law. By doing so, we can
          ...
          well as
          ensuring compliance with rules and regulations that govern property and tenancy issues. Our
          in – house
          legal liaison works together with several law firms and monitors all cases through the
          housing court
  ...
  },
  {
    ...
    text: `We understand that prompt and accurate collections of rent are necessary to efficient
          ...
          box”
          system. Of course, our office is also equipped to accept rent payments directly from our
          tenants and
          residents.Blue Slate Properties’ in house – lease renewal department ensures that leases are
          renewed
          on timely basis and proper rents are charged. We comply with all mandated relus and
          regulations set
  ...
  },
  {
    ...
    text: `At Blue Slate Properties, LLC we appreciate that prompt and precise financial reporting to
          ...
          which
          includes rent collection report for all of our owners. All statements are reviewed by the
          principals
